        ...
        <h1 class="navbar-brand navbar-brand-autodark">
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/dashboardSwasta/{id}" >
              ...
              <li class="nav-item">
                <a class="nav-link" href="/showAllPlant/{id}" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="/claimCreditCarbon">
                        Claim Credit Carbon
                      </a>
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                @if($getUser->foto)
                    <span class="avatar avatar-sm" style="background-image: url('{{ asset('storage/uploads/Profil-User/' . $getUser->foto) }}')"></span>
                @else
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                <a href="/setProfile" class="dropdown-item">Settings</a>
