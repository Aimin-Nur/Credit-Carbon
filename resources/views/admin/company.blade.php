        ...
        <div class="col-12">
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        ...
                        <div class="text-secondary">
                          Belum Diverifikasi Dinas Lingkungan Hidup Setempat
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        ...
                        <div class="text-secondary">
                          Telah Diverifikasi Dinas Lingkungan Hidup setempat
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Perusahaan yang terdaftar</h3>
              </div>
                ...
                <table class="table card-table table-vcenter text-nowrap datatable">
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      <td>
                        @if($plant->foto)
                            <span href="/" data-bs-toggle="modal" data-bs-target="#modal-large{{$plant->id}}" class="flag flag-xs" style="background-image: url('{{ asset('storage/uploads/Profil-User/' . $plant->foto) }}')"></span>
                        @else
